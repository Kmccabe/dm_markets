...
# -*- coding: utf-8 -*-
"""
Created on Mon Mar 11 13:57:19 2024


Bargaining Institution for SB Spot Market - so sellers and buyers over one item
- essentially mimics the bargaining class used before, but implements a couple
things more 
"""

import random as rnd
from institutions.dm_message_model import Message
from institutions.dm_base_bargain import Base_Bargain

class SB_Spot_Bargain(Base_Bargain):
    ...
    def __init__(self, rounds):
        ...
        # self.allow_multiple = False # indicates if you can trade multiple units
    ...
    def order_agents(self):
        """ Returns the order in which to process the agents"""
        return rnd.shuffle(self.agent_order)
    ...
    def make_bargaining_order(self):
        ...
        self.order_agents(self.agent_order)
